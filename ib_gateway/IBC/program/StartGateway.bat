...
set CONFIG=C:\Users\panov\PycharmProjects\pysystemtrade\ib_gateway\IBC\settings\config.ini
set TRADING_MODE=
set TWOFA_TIMEOUT_ACTION=exit
set IBC_PATH=C:\Users\panov\PycharmProjects\pysystemtrade\ib_gateway\IBC\program
